...
from mmdet.models.backbones import resnet_with_attention
from mmdet.models.backbones import convnext_attention
from mmdet.models.necks import nasfpn_attention
...
def inference(args, logger):
    ...
    fps = 1.0 / mean_time
    result['inference_time'] = f"{mean_time:.4f}s"
    result['fps'] = f"{fps:.2f} images/sec"
...
def main():
    ...
    print(f"Inference Time per image: {result['inference_time']}")
